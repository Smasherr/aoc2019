...
func TestCalculateDistanceToClosestIntersection(t *testing.T) {
	...
	r11, r12 := aoc2019.CalculateDistancesToClosestIntersection(wire11, wire12)
	...
	r21, r22 := aoc2019.CalculateDistancesToClosestIntersection(wire21, wire22)
	...
	r31, r32 := aoc2019.CalculateDistancesToClosestIntersection(wire31, wire32)
