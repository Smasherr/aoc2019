...
func TestCalculateThrusterSignal(t *testing.T) {
	...
	p1 := []int{4, 3, 2, 1, 0}
	assert.EqualValues(t, 43210, aoc2019.CalculateThrusterSignal(m1, p1))
}

func TestCalculateMaxThrusterSignal(t *testing.T) {
	m1 := []int{3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0}
	o11, o12 := aoc2019.CalculateMaxThrusterSignal(m1, 1)
	...
	o21, o22 := aoc2019.CalculateMaxThrusterSignal(m2, 1)
...
func TestCalculateMaxThrusterSignalFeedback(t *testing.T) {
	...
	o11, o12 := aoc2019.CalculateMaxThrusterSignal(m1, 2)
	...
	o21, o22 := aoc2019.CalculateMaxThrusterSignal(m2, 2)
